...
public class ProxyFactoryConfigV2 {
    ...
    public OrderControllerV2 orderControllerV2(LogTrace logTrace) {
        ...
        log.info("ProxyFactory proxy={}, target={}", proxy, orderControllerV2.getClass());
        return proxy;
    }
...
//        log.info("ProxyFactory proxy={}, target={}", proxy, orderServiceV2.getClass());
        return proxy;
    }
    @Bean
...
//        log.info("ProxyFactory proxy={}, target={}", proxy, orderRepositoryV2.getClass());
        return proxy;
    }
